...
=======
  templates.popover=function(n){n||(n={});var e,t=[],s=function(n){return n&&n.ecoSafe?n:n!==void 0&&null!=n?l(n):""},a=n.safe,l=n.escape;return e=n.safe=function(n){if(n&&n.ecoSafe)return n;(void 0===n||null==n)&&(n="");var e=new String(n);return e.ecoSafe=!0,e},l||(l=n.escape=function(n){return(""+n).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}),function(){(function(){var n,e,a,l,r,u,h,p,i,o,c;for(t.push('<div class="popover">\n    <a class="close">close</a>\n    <div class="inner">\n        <table>\n            <thead>\n                <tr>\n                    '),o=this.columns,l=0,h=o.length;h>l;l++)n=o[l],t.push('\n                        <th title="'),t.push(s(n)),t.push('">'),t.push(s(this.titleize(n))),t.push("</th>\n                    ");for(t.push("\n                </tr>\n            </thead>\n            <tbody>\n                "),c=this.rows,r=0,p=c.length;p>r;r++){for(e=c[r],t.push("\n                    <tr>\n                        "),u=0,i=e.length;i>u;u++)a=e[u],t.push("\n                            <td>"),t.push(s(a)),t.push("</td>\n                        ");t.push("\n                    </tr>\n                ")}t.push("\n            </tbody>\n        </table>\n    </div>\n</div>")}).call(this)}.call(n),n.safe=a,n.escape=l,t.join("")};;
  templates.config=function(n){n||(n={});var e,t=[],a=function(n){return n&&n.ecoSafe?n:n!==void 0&&null!=n?r(n):""},s=n.safe,r=n.escape;return e=n.safe=function(n){if(n&&n.ecoSafe)return n;(void 0===n||null==n)&&(n="");var e=new String(n);return e.ecoSafe=!0,e},r||(r=n.escape=function(n){return(""+n).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}),function(){(function(){t.push('<div class="hideTermsBand">\n    Term cutoff\n    <input type="range" min="1" max="5" step="1" value="'),t.push(a(this.hideTermsBand)),t.push('" />\n</div>\n\n<div class="termTextBand">\n    Term text cutoff\n    <input type="range" min="1" max="5" step="1" value="'),t.push(a(this.termTextBand)),t.push('" />\n</div>\n\n<div class="type">\n    Use a radial\n    <input type="radio" name="type" value="radial" checked="checked">\n    or a tree\n    <input type="radio" name="type" value="tree">\n    dendrogram\n</div>')}).call(this)}.call(n),n.safe=s,n.escape=r,t.join("")};;
  templates.widget=function(e){e||(e={});var n,t=[],a=function(e){return e&&e.ecoSafe?e:e!==void 0&&null!=e?l(e):""},s=e.safe,l=e.escape;return n=e.safe=function(e){if(e&&e.ecoSafe)return e;(void 0===e||null==e)&&(e="");var n=new String(e);return n.ecoSafe=!0,n},l||(l=e.escape=function(e){return(""+e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}),function(){(function(){t.push('<h4>Alleles phenotype terms for</h4> <input type="text" placeholder="MGI:97747" class="symbol three columns" value="'),t.push(a(this.symbol)),t.push('" />\n<div style="clear:both"></div>\n<div class="config">Loading &hellip;</div>\n<div class="graph"></div>')}).call(this)}.call(e),e.safe=s,e.escape=l,t.join("")};;
>>>>>>> 507166e74532038df788e9db488b62fa9ee551f6
